...
DEBUG = True  #❗️❗️to expose all the endpoints; should probably be =false for security reasons
...
REST_FRAMEWORK = {
    ...
    # for rendering camelCase in the ❗️Json response❗️ sent back to the client:
